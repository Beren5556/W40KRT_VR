...
bool logging_setting() { return bridge_flight_logger().enabled(); }
bool set_logging_setting(bool enabled) { initialize_bridge_flight_logger(); bridge_flight_logger().set_enabled(enabled); return true; }
int overlay_setting() {
